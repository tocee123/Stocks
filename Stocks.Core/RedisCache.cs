...
namespace Stocks.Core
{
    public class RedisCache : IRedisCache
    {
        ...
        public async Task WriteStocksOfInterestAsync()
        {
            ...
            //var StocksOfInterest = new[] { "T", "BAX", "KMB", "K", "IBM", "DLR", "KO", "JNJ", "MO", "PG", "WMT", "PEP", "HAS", "PM", "MMM", "BA", "WDC", "CVX", " MCD", "XOM", "RNO.PA", "CBRL", "DIS", "BLK", "TROW", "AXP", "AAPL", "COP", "EBAY", "TGT", "SPG", "JCI", "OXI", "GPS", "APA" };
